...
### 🎥 Официальный трейлер геймплея

[![MaziacsAs - Трейлер игры](https://img.youtube.com/vi/eTFzD0BkV3g/0.jpg)](https://youtu.be/eTFzD0BkV3g)
...
> 🏗️ **Примечание по коду:** В текущей версии вся логика реализована в одном файле (`main.py`). Для профессиональной разработки правильнее разбивать проект на отдельные файлы по классам, поэтому планирую перейти к такой архитектуре в следующих обновлениях.
...
![Скриншот игры](screenshots/fpnm1.png)
![Скриншот игры](screenshots/fpnm2.png)
![Скриншот игры](screenshots/camp1.png)
...
![Скриншот игры](screenshots/map1.png)
...
💡 Адреса также доступны в игре: **верхнее меню → Donate** → клик по адресу для копирования.
...
## ✨ Вдохновение
MaziacsAs вдохновлена классической игрой [Maziacs](https://en.wikipedia.org/wiki/Maziacs), созданной [Доном Пристли](https://en.wikipedia.org/wiki/Don_Priestley) (Don Priestley) в 1983 году. Эта игра — дань уважения Автору, чьи механики и творческие решения стояли у истоков жанра компьютерных игр.
---
