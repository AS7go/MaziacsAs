...
> 🏗️ **Примечание по коду:** В текущей версии вся логика реализована в одном файле (`main.py`). Я осознаю, что для профессиональной разработки правильнее разбивать проект на отдельные файлы по классам, и планирую перейти к такой архитектуре в следующих обновлениях. Буду рад советам по организации структуры!
